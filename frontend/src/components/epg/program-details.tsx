...
import { Calendar, Clock, Tag, Info, Tv } from "lucide-react"
    ...
    <div className="space-y-4 p-4">
      ...
      <div className="space-y-2">
        <div className="flex flex-wrap gap-2">
          {isPremiere && <Badge className="bg-[hsl(var(--program-premiere))] text-white">PREMIERE</Badge>}
          {isNew && !isPremiere && <Badge className="bg-[hsl(var(--program-new))] text-white">NEW</Badge>}
        ...
        {hasValidSubtitle && <p className="text-muted-foreground">{program.subtitle}</p>}
      </div>
