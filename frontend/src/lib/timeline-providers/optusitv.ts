...
export const optusitv: TimelineProvider = {
  ...
  data: {
    ...
    channels: {
      ...
      "42": [
        {
          channel_genre: "Sports",
          channel_name: "National Soccer League",
          from: 2001.6,
          to: 2002.5,
        },
      ],
      ...
      "52": [
        {
          channel_genre: "Extra",
          channel_name: "Info Active Channel",
          from: 2001.6,
          to: 2003.4,
        },
      ],
      "53": [
        {
          channel_genre: "Extra",
          channel_name: "Main Event Preview Channel",
          from: 2001.6,
          to: 2003.4,
        },
      ],
      ...
      "80": [
        {
          channel_genre: "Extra",
          channel_name: "Music Super Channel",
          from: 2001.6,
          to: 2003.4,
        },
      ],
      ...
      "300": [
        {
          channel_genre: "Movies",
          channel_name: "Near Video on Demand Stream",
          from: 2001.12,
          to: 2003.4,
        },
      ],
      ...
      "400": [
        {
          ...
          channel_name: "Installer Channel (Hidden)",
          from: 2001.12,
          to: 2003.4,
        },
      ],
    ...
    title: "Optus iTV History (2001-2003)",
  },
  description: "Optus iTV Trial Service - 2001 to 2003",
  id: "optusitv",
  name: "Optus iTV",
};
